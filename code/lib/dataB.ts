...
export const VARIANT_DEFS: VariantDef[] = [
  {
    ...
    facts: [
      { k: "Instrument", v: "Tokenized equity" },
      {
        ...
        tip: "Attested: independent accountant's reserve report, monthly · last Jun 30, 2026.",
      },
      { k: "Redemption", v: "Via issuer, KYC required" },
      { k: "Issuer location", v: "Not specified", tip: "No structured disclosure found — not necessarily that none exists. Check issuer docs." },
  ...
  },
  {
    ...
    facts: [
      { k: "Instrument", v: "Tokenized equity" },
      {
        k: "Backing",
        v: "Backed 1:1 (issuer-stated)",
        tip: "Attested: proof-of-reserve feed + auditor report · last Jun 2026.",
      },
