    ...
    <>
      ...
      >
        <span style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0 }}>
          <svg width="14" height="14" viewBox="0 0 19.4434 19.2676" fill="var(--color-ink-muted)" style={{ flexShrink: 0 }} aria-hidden="true">
          ...
          <span className="hv-search-text">Find tokens...</span>
        </span>
        <span className="hv-search-kbd" style={{ display: "flex", gap: 4, flexShrink: 0 }}>
          <kbd
            style={{
